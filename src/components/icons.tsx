...
export function FileIcon({ className = "size-5" }: { className?: string }) {
  return (
...
export function MoonIcon({ className = "size-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M20.4 14.7A8.6 8.6 0 0 1 9.3 3.6a.7.7 0 0 0-.86-.92A9.9 9.9 0 1 0 21.32 15.6a.7.7 0 0 0-.92-.9Z" />
    </svg>
  );
}
